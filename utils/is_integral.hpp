...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/02 23:31:31 by vmiseiki          #+#    #+#             */
/*   Updated: 2022/12/04 19:14:08 by vmiseiki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft{
	...
	template <>          struct is_integral<const volatile char16_t>              	: public true_type  {};
	template <>          struct is_integral<const volatile char32_t>              	: public true_type  {};
} 
